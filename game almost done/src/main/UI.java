...
public class UI {
    ...
    public boolean firstBossDeath = false;
    public boolean healthPointsBelow = false;
    public boolean tookTooLongWitchEnding = false;
    public boolean healthTwoLowToDefeat = false;
    public boolean notEnoughStrength = false;
    public double playTime;
    public boolean tooLowOfHP = false;
    ...
    public void draw(Graphics2D g2) {
        ...
        if (gameFinished == true) {
            ...
            text = "Bosses Defeated: " + gp.player.bossDeath;
            textLength = (int)g2.getFontMetrics().getStringBounds(text, g2).getWidth();
            x = gp.screenWidth/2 - (textLength/2);
            ...
            text = "You Were Too Slow The Boss Beat You";
            textLength = (int)g2.getFontMetrics().getStringBounds(text, g2).getWidth();
            x = gp.screenWidth/2 - (textLength/2);
            y = gp.screenWidth/2 - (gp.tileSize*2);
            g2.drawString(text, x, y);
            ...
            text = "You Did Not Have Enough HP";
            textLength = (int)g2.getFontMetrics().getStringBounds(text, g2).getWidth();
            x = gp.screenWidth/2 - (textLength/2);
            y = gp.screenWidth/2 - (gp.tileSize*2);
            g2.drawString(text, x, y);
        ...
        else if (healthPointsBelow == true) {
            g2.setFont(arial_40);
            g2.setColor(Color.white);
            String text;
            int  textLength;
        ...
        else if (tookTooLongWitchEnding == true) {
            g2.setFont(arial_40);
            g2.setColor(Color.white);
            String text;
            int  textLength;
        ...
        else if (healthTwoLowToDefeat == true) {
            g2.setFont(arial_40);
            g2.setColor(Color.white);
            String text;
            int  textLength;
            ...
            text = "The Enemy Killed You (Too Low Of HP)";
            textLength = (int)g2.getFontMetrics().getStringBounds(text, g2).getWidth();
            x = gp.screenWidth/2 - (textLength/2);
            y = gp.screenWidth/2 - (gp.tileSize*2);
            g2.drawString(text, x, y);
        ...
        else if (notEnoughStrength == true) {
            g2.setFont(arial_40);
            g2.setColor(Color.white);
            String text;
            int  textLength;
            ...
            text = "The Enemy Killed You (Not Strong Enough)";
            textLength = (int)g2.getFontMetrics().getStringBounds(text, g2).getWidth();
            x = gp.screenWidth/2 - (textLength/2);
            y = gp.screenWidth/2 - (gp.tileSize*2);
            g2.drawString(text, x, y);
